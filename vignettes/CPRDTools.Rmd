...
In order to list all loaded tables in the database, similar to the output in the `$loaded_tables`, returned when loading data via the data-loading function spreviously, specify
```{r}
